...
def handle_winner(user_choice: str):
    ...
    while user_points < game_match and ai_points < game_match:
...
Button(GameRoot, image=rock_photo, command=handle_winner("rock"), width=220, height=220, pady=20).grid(column=0, row=1)
Button(GameRoot, image=scissors_photo, command=handle_winner("scissors"), width=220, height=220, pady=20).grid(column=1,
                                                                                                               row=1)
Button(GameRoot, image=paper_photo, command=handle_winner("paper"), width=220, height=220, pady=20).grid(column=3,
                                                                                                         row=1)
